...
import course_description_data from '@/src/data/course-decription-data'
...
const CourseDetailsArea = () => {
  ...
  const course = our_course_data.find(
    (data) => data.id === Number(router.query.id)
  )
  const description = course_description_data.find(
    (data) => data.id === Number(router.query.id)
  )
  ...
  return (
    <>
      <section
        className="c-details-area pt-120 pb-50 wow fadeInUp bg-light"
